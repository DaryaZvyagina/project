							...
							<div class="col-xs-12 col-md-12 "> 
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-10">
										  <input type="text" class="form-control" id="title" placeholder="Введите название новости">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
										  <input type="date" class="form-control" id="date" placeholder="Введите дату события">
										</div>
									</div>
									<div class="form-group">
										<label for="url_s" class="col-sm-2 control-label">Ссылка на событие</label>
										<div class="col-sm-10">
										  <input type="text" class="form-control" id="url_s" placeholder="Введите ссылку на событие">
										</div>
									</div>
									<div class="form-group">
